...
const routes = [
    ...
    {name:"Login",path:"/login",component:()=>import("../Page/Attemp/Login.vue"),meta:{pageNotAuth:true}},
    {name:"Sigin",path:"/sigin",component:()=>import("../Page/Attemp/Sigin.vue"),meta:{pageNotAuth:true}},
